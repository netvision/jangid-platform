...
const _routes = [
  {
    name: "demo",
    path: "/demo",
    component: () => import('./demo-CloqF10n.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "terms",
    path: "/terms",
    component: () => import('./terms-DoKhO5OY.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import('./privacy-B2VC_xBx.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import('./login-CXTMX0FB.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
  ...
  },
  {
    name: "pricing",
    path: "/pricing",
    component: () => import('./index-DWVQ1UmH.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": ["authenticated"] },
    component: () => import('./index-BmV7LCR-.mjs')
  },
  {
    name: "profiles-slug",
    path: "/profiles/:slug()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_slug_-BJJMxY2n.mjs')
  },
  {
    name: "categories",
    path: "/categories",
  ...
  },
  {
    name: "highlights",
    path: "/highlights",
    component: () => import('./index-DustCh25.mjs')
  },
  {
...
const namedMiddleware = {
  authenticated: () => import('./authenticated-DbEqzUqY.mjs'),
  "super-admin": () => import('./super-admin-D3d2ZXB6.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-jMO8duBQ.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-C6z5VgwT.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-C9kGGw8X.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DAusnrtP.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Dbibx0yf.mjs'));
...
export { _export_sfc as _, useRuntimeConfig as a, useNuxtApp as b, asyncDataDefaults as c, createError as d, entry$1 as default, defineNuxtRouteMiddleware as e, findHighlightProfile as f, useState as g, highlightProfiles as h, defineAppConfig as i, useRouter as j, nuxtLinkDefaults as k, defineStore as l, navigateTo as n, resolveRouteObject as r, storeToRefs as s, useHead as u };
